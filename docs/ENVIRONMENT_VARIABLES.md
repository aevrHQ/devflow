...
| ------------------------- | ------ | ---------------------------- | ----------------------------------------- |
| `PLATFORM_URL`            | string | `https://devflow.aevr.space` | DevFlow SaaS platform URL                 |
| `NEXT_PUBLIC_BASE_URL`    | string | `http://localhost:3000`      | Web app base URL (public)                 |
| `NEXT_PUBLIC_DEVFLOW_URL` | string | `http://localhost:3000`      | Platform base URL (public)                |
| `AGENT_HOST_URL`          | string | `http://localhost:3001`      | Agent-host server URL                     |
| `DEVFLOW_API_URL`         | string | `http://localhost:3000`      | Platform API URL (internal)               |
